...
_OPTIONS = [
    ...
    ("Tell AutoCode what to change", PlanChoice.FEEDBACK),
]
...
class InlinePlanWidget(Vertical, can_focus=True):
    ...
    def _build_content(self) -> str:
        lines = [
            "\n [bold #d77757]AutoCode has written up a plan and is ready to execute. "
            "Would you like to proceed?[/bold #d77757]\n"
        ]
