...
from autocode.serialization import build_messages
...
SESSION_SUBDIR = ".autocode/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from autocode.tools.base import StreamEnd, StreamEvent, TextDelta
