...
from autocode.skills.parser import SkillDef, substitute_arguments
from autocode.tools import ToolRegistry

if TYPE_CHECKING:
    from autocode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from autocode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
