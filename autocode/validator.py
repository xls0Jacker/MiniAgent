...
def validate_max_iterations(value: object) -> int:
    """校验 max_iterations 配置字段（Agent 主循环最大迭代次数）。"""
...
def validate_config_structure(raw: object) -> dict:
    ...
    返回的字典包含以下键：
        providers、permission_mode、mcp_servers、hooks、max_iterations
    """
    ...
    return {
        ...
        "max_iterations": validate_max_iterations(raw.get("max_iterations", 50)),
    }
